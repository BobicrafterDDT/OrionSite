...
function ee(e, t) {
    ...
    for (const n of t.querySelectorAll(`[${b}]`)) {
        ...
        r && (r.replaceWith(n),
              r.localName === "astro-island" && oe(n) && !re(n, r) && (n.setAttribute("ssr", ""),
...
async function me(e, t, n, o, r, s, u, a, l) {
    ...
    return document.dispatchEvent(f) && (await f.loader(),
                                         f.defaultPrevented || (ue(ae),
                                                                f.navigationType !== "traverse" && D({
                                                                    scrollX,
                                                                    scrollY
                                                                }))),
                                                                f
...
let O, y = 0;
history.state ? (y = history.state.index,
                 scrollTo({
                 ...
                 async function F(e, t, n, o, r) {
                     ...
                     W(a.to, a.from, t, u, o),
                     B(le),
                     r === "animate" && (!n.transitionSkipped && !a.signal.aborted ? s("new").finally( () => n.viewTransitionFinished()) : n.viewTransitionFinished())
                 }
                 function ve() {
                     return d?.controller.abort(),
                     d = {
                 ...
                 async function j(e, t, n, o, r) {
                     ...
                     async function l(i) {
                         ...
                         if (i.formData) {
                             h.method = "POST";
                             const g = i.sourceElement instanceof HTMLFormElement ? i.sourceElement : i.sourceElement instanceof HTMLElement && "form"in i.sourceElement ? i.sourceElement.form : i.sourceElement?.closest("form");
                             h.body = g?.attributes.getNamedItem("enctype")?.value === "application/x-www-form-urlencoded" ? new URLSearchParams(i.formData) : i.formData
                         }
                     ...
                     if (document.documentElement.setAttribute(M, a.direction),
                         x)
                 ...
                 function Re() {
                     ...
                     return new IntersectionObserver( (t, n) => {
                         for (const o of t) {
                             const r = o.target
                             , s = e.get(r);
                             o.isIntersecting ? (s && clearTimeout(s),
                                                 e.set(r, setTimeout( () => {
                                                     n.unobserve(r),
                                                                      e.delete(r),
                                                                      S(r.href)
                 ...
                 function ke(e, t) {
                     ...
                     try {
                         ...
                         return location.origin === n.origin && (location.pathname !== n.pathname || location.search !== n.search) && !K.has(e)
                     } catch {}
                     return !1
                 }
                 function v(e, t) {
                     ...
                     return n === "false" ? !1 : t === "tap" && (n != null || k) && z() ? !0 : n == null && k || n === "" ? t === G : n === t
                 }
                 function z() {
                 ...
                 (x || De() !== "none") && (document.addEventListener("click", e => {
                     let t = e.target;
